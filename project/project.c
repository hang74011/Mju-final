...
int main ( int argc , char *argv[])
{
   ...
   ledtextwrite("1","start");
    ...
    int sajin9[10][9]={ {2,9,1,7,9,0,2,4,7},{3,8,2,5,1,9,4,8,5},{4,7,3,4,7,2,8,4,9},{5,6,4,3,6,0,3,1,5} ,{6,5,5,8,9,0,1,6,2 },{7,4,6,1,8,5,4,3,7},{8,3, 7,5,2,5,1,0,7},{9,2,8,2,6,8,9,3,4 },{6,1,9,6,7,2,9,8,5},{1,5,1,9,1,0,3,4,6 }}; //5스테이지에 나오는 문제를 배열로 선언
